...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0301')
ventas_bs_baralt = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0301')
ventas_csh_baralt = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0301')
ventas_usd_baralt , transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0301')
ventas_efe_baralt = v_usd_efe.diario_efectivo_usd()

print(ventas_usd_baralt)