...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0402')
ventas_bs_upata = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0402')
ventas_csh_upata = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0402')
ventas_usd_upata,transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0402')
ventas_efe_upata = v_usd_efe.diario_efectivo_usd()