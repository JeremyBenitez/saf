...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0202')
ventas_bs_cabimas = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0202')
ventas_csh_cabimas = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0202')
ventas_usd_cabimas , transacciones= v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0202')
ventas_efe_cabimas = v_usd_efe.diario_efectivo_usd()