...
fecha_difecha_hace_1Day = fecha_diaria - timedelta(days=1)
...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0501')
ventas_bs_cagua = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0501')
ventas_csh_cagua = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0501')
ventas_usd_cagua , transacciones= v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0501')
ventas_efe_cagua = v_usd_efe.diario_efectivo_usd()   