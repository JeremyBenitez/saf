...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0302')
ventas_bs_maturin = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0302')
ventas_csh_maturin = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0302')
ventas_usd_maturin,transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0302')
ventas_efe_maturin = v_usd_efe.diario_efectivo_usd()
