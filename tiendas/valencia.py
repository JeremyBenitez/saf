...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0102')
ventas_bs_valencia = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0102')
ventas_csh_valencia = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0102')
ventas_usd_valencia,transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0102')
ventas_efe_valencia = v_usd_efe.diario_efectivo_usd()   
