...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0207')
ventas_bs_catia = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0207')
ventas_csh_catia = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0207')
ventas_usd_catia ,transacciones= v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0207')
ventas_efe_catia = v_usd_efe.diario_efectivo_usd()