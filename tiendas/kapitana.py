...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0101')
ventas_bs_kapitana = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0101')
ventas_csh_kapitana = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0101')
ventas_usd_kapitana,transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0101')
ventas_efe_kapitana = v_usd_efe.diario_efectivo_usd()

print(ventas_usd_kapitana)
print(transacciones)