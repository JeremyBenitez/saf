...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0204')
ventas_bs_guanare = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0204')
ventas_csh_guanare = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0204')
ventas_usd_guanare,transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0204')
ventas_efe_guanare = v_usd_efe.diario_efectivo_usd()