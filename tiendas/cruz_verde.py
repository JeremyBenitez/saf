...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0201')
ventas_bs_cruz_v = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0201')
ventas_csh_cruz_v = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0201')
ventas_usd_cruz_v,transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0201')
ventas_efe_cruz_v = v_usd_efe.diario_efectivo_usd()   
