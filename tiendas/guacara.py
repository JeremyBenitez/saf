...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0103')
ventas_bs_guacara = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0103')
ventas_csh_guacara = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0103')
ventas_usd_guacara,transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0103')
ventas_efe_guacara = v_usd_efe.diario_efectivo_usd()   
