...
v_bs = ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0203')
ventas_bs_babilon = v_bs.diaro_bs()    

v_csh=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0203')
ventas_csh_babilon = v_csh.diario_cashea()

v_usd=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0203')
ventas_usd_babilon , transacciones = v_usd.diario_usd()

v_usd_efe=ventas_x_tiendas(str(fecha_diaria),str(fecha_diaria),'0203')
ventas_efe_babilon = v_usd_efe.diario_efectivo_usd()

print(ventas_usd_babilon)