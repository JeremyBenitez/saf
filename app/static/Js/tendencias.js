// Variable global para almacenar los datos de los departamentos
            ...
            /// Función para generar datos ficticios del Top 20
            function generateFakeTop20Data(departmentCode) {
                const fakeData = [];
                for (let i = 1; i <= 20; i++) {
                    fakeData.push({
                        nombre: `Producto ${i} - ${departmentCode}`,
                        codigo: `COD${i}${departmentCode}`,
                        cantidad: Math.floor(Math.random() * 1000) + 100 // Cantidad aleatoria entre 100 y 1100
                    });
                }
                return fakeData;
            }
